...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_BINDS = {
        'ItemStorage': 'mysql+pymysql://root:fengjunguo@localhost:3306/run_admin_itemstorage?charset=utf8',
        'DB2019': 'mysql+pymysql://root:fengjunguo@localhost:3306/run_admin_db_2019?charset=utf8',
        'DB2018': 'mysql+pymysql://root:fengjunguo@localhost:3306/run_admin_db_2018?charset=utf8',
    }
...
class ProductionConfig(Config):
    ...
    """
    #可以通过修改SQLALCHEMY_DATABASE_URI来控制访问不同数据库
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:root@192.168.66.188/production?charset=utf8'
